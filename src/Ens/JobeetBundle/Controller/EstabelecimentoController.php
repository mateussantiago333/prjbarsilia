...
class EstabelecimentoController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $query = $em->createQuery('SELECT e.id,e.nome_estabelecimento,AVG(c.nota) as nota_media,
                e.descricao, e.url_img,e.cidade FROM EnsJobeetBundle:Estabelecimento e LEFT JOIN e.comentario c WHERE e.id NOT NULL OR e.cidade = :cidade GROUP BY e.id ORDER BY nota_media DESC')->setParameter('cidade', $cidade);
